...
export default class Statistics {
  ...
  public renderButtons(canvas: HTMLCanvasElement) {
    // CanvasUtil.fillRectangle(canvas, canvas.width / 1.15, canvas.height / 3, canvas.height / 50, canvas.height / 50, 150, 150, 150, 1, canvas.height / 200);
    // CanvasUtil.drawRectangle(canvas, canvas.width / 1.15, canvas.height / 3, canvas.height / 50, canvas.height / 50, 30, 30, 30, 1, 1, canvas.height / 200);
  }
