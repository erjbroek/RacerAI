...
export default class Finished {
  ...
  public endRound(canvas: HTMLCanvasElement): void {
    ...
    CanvasUtil.writeText(canvas, `${HandleScore.maxSpeed.toFixed(1)} m/s`, canvas.width / 3, canvas.height / 4, 'right', 'Arial', 25, 'white');
    ...
    CanvasUtil.writeText(canvas, 'Amount hit', canvas.width / 1.32, canvas.height / 6, 'right', 'Arial', 25, 'white');
