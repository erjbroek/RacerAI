...
export default class Slider {
    ...
    renderSlider(canvas) {
        ...
        if (!this.hoverInfo) {
            ...
            CanvasUtil.fillRectangle(canvas, this.posX + this.width * 0.9, this.posY * 0.98, canvas.width * 0.1, canvas.height * 0.11, 255, 255, 255, 0.8, 4.5);
            CanvasUtil.drawRectangle(canvas, this.posX + this.width * 0.9, this.posY * 0.98, canvas.width * 0.1, canvas.height * 0.11, 0, 0, 0, 1, 2, 4.5);
